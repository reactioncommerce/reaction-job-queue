...
/*
  ...
  Original License: https://github.com/vsivsi/meteor-job-collection/blob/master/LICENSE
 */

export function createJobCollectionBaseClass({ Meteor, Mongo, check, Match, later, Job }) {
